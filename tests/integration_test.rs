...
/*
     date      |      time       |          timestamp           |                interval                |      timetz
---------------+-----------------+------------------------------+----------------------------------------+-------------------
 4713-01-01 BC | 04:05:06.789    | 4713-01-01 04:05:06.789 BC   | 00:00:00                               | 04:05:06.789-08
 0002-12-31    | 00:00:00        | 0002-12-31 00:00:00          | -1 years -2 mons -3 days -04:05:06     | 04:05:06-08
 2200-01-01    | 16:05:00        | 2200-01-01 16:05:00          | -1 years -1 mons +12 days -00:12:47.88 | 04:05:06+03:02:01
 5874897-12-31 | 23:59:59.999999 | 294276-12-31 23:59:59.999999 | 00:00:00.000015                        | 04:05:06.789+00
*/
#[test]
fn test_dates_and_times() -> Result<(), CasErr> {
    ...
    let expected = format!(
        "[{},{},{},{}]\n",
        r#"{"date":"-4712-01-01","time":"04:05:06.789","timestamp":"-4712-01-01T04:05:06.789Z","interval":"P0D","timetz":"04:05:06.789-08:00"}"#,
        r#"{"date":"0002-12-31","time":"00:00:00","timestamp":"0002-12-31T00:00:00Z","interval":"P-1Y-2M-3DT-4H-5M-6S","timetz":"04:05:06-08:00"}"#,
        r#"{"date":"2200-01-01","time":"16:05:00","timestamp":"2200-01-01T16:05:00Z","interval":"P-1Y-1M12DT-12M-47.88S","timetz":"04:05:06+03:02:01"}"#,
        r#"{"date":"5874897-12-31","time":"23:59:59.999999","timestamp":"294276-12-31T23:59:59.999999Z","interval":"PT0.000015S","timetz":"04:05:06.789+00:00"}"#,
    );
    assert_eq!(std::str::from_utf8(&out).unwrap(), expected);
    Ok(())
}
